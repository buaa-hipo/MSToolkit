...
#define JSI_DEV_BUFFER_SIZE (1024 * 1024)
...
extern std::array<std::array<void*, 24>, 4> callback_buffers;  ///< Callback buffer pools of each cluster.
extern std::array<std::array<void*, 24>, 4> activity_buffers;  ///< First activity buffer pools of each cluster.
extern std::array<uint32_t*, 4> callback_writing_indices;  ///< Indices of callback buffer currently being written to (bitmap).
extern std::array<uint32_t*, 4> callback_ready_indices;    ///< Indices of callback buffer currently ready (bitmap).
extern std::array<uint32_t*, 4> activity_writing_indices;  ///< Indices of activity buffer currently being written to (bitmap).
extern std::array<uint32_t*, 4> activity_ready_indices;    ///< Indices of activity buffer currently ready (bitmap).
extern std::array<uint32_t*, 4> callback_used_host;             ///< Used callback buffer size (in bytes), length=48.
extern std::array<uint32_t*, 4> activity_used_host;             ///< Used activity buffer size (in bytes), length=48.
...
inline accl_status_t accl_next_record(const accl_activity_record_t *cur,
                                      const accl_activity_record_t **next) {
