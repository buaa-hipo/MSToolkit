...
void dslash(spinor_field dst, su3_field link, spinor_field src){
    ...
    instrumented_hthread_group_exec(group_id,"dslash_backward_neighbour",0,5,args); //(3*4*2*2+2*3*2)*8*16*32*32*3+(3*4*2*2+2*3*2)*8*16*16*32 = 27525120
    ...
    instrumented_hthread_group_exec(group_id,"dslash_main",0,3,args);//(3*4*2*2+2*3*2*4)*16*16*32*32*8 = 201326592
    instrumented_hthread_group_wait(group_id);
    ...
    start = std::chrono::high_resolution_clock::now();
    instrumented_hthread_group_exec(group_id,"dslash_forward_neighbour",0,4,args);//(3*4*2*2+2*3*2)*8*16*32*32*2+(3*4*2*2+2*3*2)*8*16*16*32*2 = 27525120
