...
void parse(int argc, char *argv[]) {
    cxxopts::Options options("jsicompress", "Compress the mpi trace directory generated by jsirun.");
    options.add_options()
        ("h,help", "Print help")
        ("i,input", "Input mpi trace directory generated by jsirun", cxxopts::value<std::string>())
        ;
