...
static char* get_hostname_from_meta(RankMetaCollection& metas, int rank) {
...
bool BF_TimelineAlignment::align(RecordTraceCollection& collection, RankMetaCollection& metas) {
    uint64_t max_ts = 0;
