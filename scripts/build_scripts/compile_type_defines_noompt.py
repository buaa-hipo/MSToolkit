...
# wrap_defines_macro.h
def generate_wrap_define_macro(EVENT_LIST, WORKDIR):
    output_include = WORKDIR+"/include/record/wrap_defines_macro.h"
    include_header = '''
...
def generate_type_info(EVENT_LIST, WORKDIR):
    ...
    record_type_info_file = WORKDIR + '/lib/record/record_type_info.cpp'
...
file_path = args.workdir+'/include/record/record_types_noompt.def'
...
generate_wrap_define_macro(event_list,WORKDIR)
